...
Gemessen am 28. Juli 2026 gegen das gebaute `dist/` mit exakt den
...
| -------- | ------- | ----- | -------- |
| LCP      | 0.4 s   | 2.0 s | < 2,5 s  |
| CLS      | 0.011   | 0.001 | < 0,1    |
| TBT      | 0 ms    | 10 ms | < 200 ms |
| FCP      | 0.3 s   | 1.4 s |          |
...
also inklusive des vollständigen Openers. Ab dem zweiten Aufruf
entfällt dieser und die Werte fallen deutlich besser aus.
